...
<html>
  <head>
    ...
    <script>
    	var <%= I_CmsGalleryProviderConstants.KEY_FIELD_ID %> = '<%= HtmlUtils.htmlEscape(HtmlUtils.htmlUnescape(CmsStringUtil.escapeJavaScript(request.getParameter(I_CmsGalleryProviderConstants.KEY_FIELD_ID)))) %>';
