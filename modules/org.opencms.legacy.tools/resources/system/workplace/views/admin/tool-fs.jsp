...
<html>
  ...
  <frameset rows="57,*" border="0" frameborder="0" framespacing="0">
    ...
    <frame <%= HtmlUtils.htmlEscape(HtmlUtils.htmlUnescape(wp.getFrameSource("tool_content", jsp.link(wp.getAdminTool().getHandler().getLink()) + "?" + wp.allParamsAsRequest()))) %> frameborder="0" border="0" framespacing="0" marginheight="7" marginwidth="7" noresize scrolling="auto">
  </frameset>
</html>
